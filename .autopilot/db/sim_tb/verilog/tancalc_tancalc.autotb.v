...
`define AUTOTB_TVIN_output_V  "./c.tancalc_tancalc.autotvin_output_V.dat"
...
`define AUTOTB_TVIN_output_V_out_wrapc  "./rtl.tancalc_tancalc.autotvin_output_V.dat"
`define AUTOTB_TVOUT_output_V  "./c.tancalc_tancalc.autotvout_output_V.dat"
`define AUTOTB_TVOUT_output_V_out_wrapc  "./impl_rtl.tancalc_tancalc.autotvout_output_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.tancalc_tancalc.autotvout_output_V.dat", "r");
    fp2 = $fopen("./impl_rtl.tancalc_tancalc.autotvout_output_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.tancalc_tancalc.autotvout_output_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.tancalc_tancalc.autotvout_output_V.dat\"!");
    else begin
        $display("Comparing rtl.tancalc_tancalc.autotvout_output_V.dat with impl_rtl.tancalc_tancalc.autotvout_output_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
