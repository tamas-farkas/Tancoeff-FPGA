...
//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.tancalc_tancalc.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.tancalc_tancalc.autotvout_gmem0.dat"
 parameter gmem0_ADDR_BITWIDTH = 32'd 64;
 parameter gmem0_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem0_DATA_BITWIDTH = 32'd 512;
...
parameter gmem0_C_DATA_BITWIDTH = 32'd 512;
parameter gmem0_mem_depth = 32'd 640;
...
output [64 - 1 : 0] TRAN_gmem0_input_V;
input ready;
input done;
...
assign    TRAN_gmem0_input_V = input_V;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/student/workspace/tancoeff/tancoeff/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/student/workspace/tancoeff/tancoeff/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
