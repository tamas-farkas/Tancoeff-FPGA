...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename data_local_V \
    op interface \
    ports { data_local_V_address0 { O 10 vector } data_local_V_ce0 { O 1 bit } data_local_V_we0 { O 128 vector } data_local_V_d0 { O 1024 vector } data_local_V_q0 { I 1024 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_local_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 5 \
    name datapop_local_V \
    reset_level 1 \
    sync_rst true \
    dir IO \
    corename datapop_local_V \
    op interface \
    ports { datapop_local_V_address0 { O 10 vector } datapop_local_V_ce0 { O 1 bit } datapop_local_V_we0 { O 1 bit } datapop_local_V_d0 { O 11 vector } datapop_local_V_q0 { I 11 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'datapop_local_V'"
}
}
