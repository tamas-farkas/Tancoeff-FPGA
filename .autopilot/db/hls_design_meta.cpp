...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("output_V_TDATA", 512, hls_out, 2, "axis", "out_data", 1),
	Port_Property("output_V_TVALID", 1, hls_out, 2, "axis", "out_vld", 1),
	Port_Property("output_V_TREADY", 1, hls_in, 2, "axis", "out_acc", 1),
