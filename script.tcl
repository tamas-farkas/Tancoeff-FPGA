...
config_export -format ip_catalog -rtl verilog -vivado_phys_opt none -vivado_report_level 0 -xo /home/student/workspace/tancalc.xo
config_compile -name_max_length 256 -no_signed_zeros=0 -pipeline_loops 64 -unsafe_math_optimizations=0
config_rtl -auto_prefix=0 -encoding onehot -mult_keep_attribute=0 -reset control -reset_async=0 -reset_level high -verbose=0
