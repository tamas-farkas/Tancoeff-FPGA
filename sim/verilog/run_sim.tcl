...
if {[file isfile tancalc_tancalc.autotvin.dat]} {
	file delete -force tancalc_tancalc.autotvin.dat
}

if {[file isfile tancalc_tancalc.autotvout.dat]} {
	file delete -force tancalc_tancalc.autotvout.dat
}
