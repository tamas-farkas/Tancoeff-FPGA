...
if {[file isfile hier_func_hier_func.autotvin.dat]} {
	file delete -force hier_func_hier_func.autotvin.dat
}

if {[file isfile hier_func_hier_func.autotvout.dat]} {
	file delete -force hier_func_hier_func.autotvout.dat
}
