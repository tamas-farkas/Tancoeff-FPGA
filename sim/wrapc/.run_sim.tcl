...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "tancalc_tancalc.autotvin.dat"
	set constFileTvOut       "tancalc_tancalc.autotvout.dat"
	set constFileHdlTvIn     "tancalc_tancalc.autohdltvin.dat"
	set constFileHdlTvOut    "tancalc_tancalc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
