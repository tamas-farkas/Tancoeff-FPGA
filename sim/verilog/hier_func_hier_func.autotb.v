...
`define AUTOTB_DUT      hier_func_hier_func
`define AUTOTB_DUT_INST AESL_inst_hier_func_hier_func
`define AUTOTB_TOP      apatb_hier_func_top
`define AUTOTB_LAT_RESULT_FILE "hier_func_hier_func.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hier_func_hier_func.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hier_func_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 1.67

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_tancalc_input_V 1
`define AESL_DEPTH_fifo_output_V_V 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.hier_func_hier_func.autotvin_gmem0.dat"
`define AUTOTB_TVIN_tancalc_input_V_out_wrapc  "../tv/rtldatafile/rtl.hier_func_hier_func.autotvin_tancalc_input_V.dat"
`define AUTOTB_TVIN_fifo_output_V_V_out_wrapc  "../tv/rtldatafile/rtl.hier_func_hier_func.autotvin_fifo_output_V_V.dat"
`define AUTOTB_TVOUT_fifo_output_V_V  "../tv/cdatafile/c.hier_func_hier_func.autotvout_fifo_output_V_V.dat"
`define AUTOTB_TVOUT_fifo_output_V_V_out_wrapc  "../tv/rtldatafile/rtl.hier_func_hier_func.autotvout_fifo_output_V_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4111;
parameter LENGTH_gmem0 = 640;
parameter LENGTH_tancalc_input_V = 1;
parameter LENGTH_fifo_output_V_V = 3840;
...
wire [15 : 0] fifo_output_V_V_TDATA;
wire  fifo_output_V_V_TVALID;
wire  fifo_output_V_V_TREADY;
integer done_cnt = 0;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .fifo_output_V_V_TDATA(fifo_output_V_V_TDATA),
    .fifo_output_V_V_TVALID(fifo_output_V_V_TVALID),
...
reg [31:0] ap_c_n_tvin_trans_num_fifo_output_V_V;

reg fifo_output_V_V_ready_reg; // for self-sync

wire fifo_output_V_V_ready;
wire fifo_output_V_V_done;
wire [31:0] fifo_output_V_V_transaction;
wire axi_s_fifo_output_V_V_TVALID;
wire axi_s_fifo_output_V_V_TREADY;

AESL_axi_s_fifo_output_V_V AESL_AXI_S_fifo_output_V_V(
    .clk(AESL_clock),
    .reset(AESL_reset),
    .TRAN_fifo_output_V_V_TDATA(fifo_output_V_V_TDATA),
    .TRAN_fifo_output_V_V_TVALID(axi_s_fifo_output_V_V_TVALID),
    .TRAN_fifo_output_V_V_TREADY(axi_s_fifo_output_V_V_TREADY),
    .ready(fifo_output_V_V_ready),
    .done(fifo_output_V_V_done),
    .transaction(fifo_output_V_V_transaction));

assign fifo_output_V_V_ready = 0;
assign fifo_output_V_V_done = AESL_done;

assign axi_s_fifo_output_V_V_TVALID = fifo_output_V_V_TVALID;

reg reg_fifo_output_V_V_TREADY;
initial begin : gen_reg_fifo_output_V_V_TREADY_process
    integer proc_rand;
    reg_fifo_output_V_V_TREADY = axi_s_fifo_output_V_V_TREADY;
    while(1)
    begin
        @(axi_s_fifo_output_V_V_TREADY);
        reg_fifo_output_V_V_TREADY = axi_s_fifo_output_V_V_TREADY;
    end
end


assign fifo_output_V_V_TREADY = reg_fifo_output_V_V_TREADY;

wire    AESL_axi_master_gmem0_ready;
wire    AESL_axi_master_gmem0_done;
wire [64 - 1:0] tancalc_input_V;
AESL_axi_master_gmem0 AESL_AXI_MASTER_gmem0(
    ...
    .TRAN_gmem0_tancalc_input_V (tancalc_input_V),
...
AESL_axi_slave_control AESL_AXI_SLAVE_control(
    ...
    .TRAN_tancalc_input_V (tancalc_input_V),
...
reg end_tancalc_input_V;
reg [31:0] size_tancalc_input_V;
reg [31:0] size_tancalc_input_V_backup;
reg end_fifo_output_V_V;
reg [31:0] size_fifo_output_V_V;
reg [31:0] size_fifo_output_V_V_backup;
...
reg dump_tvout_finish_fifo_output_V_V;

initial begin : dump_tvout_runtime_sign_fifo_output_V_V
    integer fp;
    dump_tvout_finish_fifo_output_V_V = 0;
    fp = $fopen(`AUTOTB_TVOUT_fifo_output_V_V_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_fifo_output_V_V_out_wrapc);
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_fifo_output_V_V_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_fifo_output_V_V_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_fifo_output_V_V = 1;
end
