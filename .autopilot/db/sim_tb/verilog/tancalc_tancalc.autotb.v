...
`define AUTOTB_TVIN_output_r  "./c.tancalc_tancalc.autotvin_output_r.dat"
...
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.tancalc_tancalc.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem1  "./c.tancalc_tancalc.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "./impl_rtl.tancalc_tancalc.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 751;
parameter LENGTH_gmem0 = 8192;
parameter LENGTH_gmem1 = 1;
