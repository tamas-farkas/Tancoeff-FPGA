...
// ==============================================================
`timescale 1 ns / 1 ps
module tancalc_tancalc_ref_local_V_ram (addr0, ce0, d0, we0, q0,  clk);
...
`timescale 1 ns / 1 ps
module tancalc_tancalc_ref_local_V(
    reset,
    clk,
    address0,
    ce0,
...
tancalc_tancalc_ref_local_V_ram tancalc_tancalc_ref_local_V_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
